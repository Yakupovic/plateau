...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDF89 Il y a 1 an jour pour jour, tu battais ton record de ", souvenirRecord.nom, " \xE0 ", fmtKg(souvenirRecord.poids), " kg."), alerteDouleur && /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDFB5 Playlist d'entra\xEEnement \u2192"), cycleDe(data).deload && /*#__PURE__*/React.createElement("div", {
    ...
    }, fmtDate(s.date), s.duree ? ` · ${fmtDuree(s.duree)}` : "", s.gourdes != null ? ` · ${s.gourdes} 🥤` : "", ` · ${s.exos.length} exos`)), open ? /*#__PURE__*/React.createElement(ChevronUp, {
      size: 18,
      style: {
        color: C.dim
      }
  ...
  }, "Tape un groupe pour fixer sa cible de s\xE9ries hebdo. Un groupe \xE0 0 m\xE9rite ta prochaine s\xE9ance."), /*#__PURE__*/React.createElement("div", {
    className: "mt-4 pt-3",
    style: {
      borderTop: `1px solid ${C.line}`
    }
