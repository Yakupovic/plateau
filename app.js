...
function MiniLine({
  ...
  const areaD = pts.length > 1 ? "M " + pts[0][0] + " " + floor + " L " + pts.map(p => p.join(" ")).join(" L ") + " L " + pts[pts.length - 1][0] + " " + floor + " Z" : "";
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: "#6a6a73",
    textAnchor: "end"
  }, fmtV(g)))), areaD && /*#__PURE__*/React.createElement("path", {
    d: areaD,
    fill: `url(#${gid})`
  }), refY != null && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("line", {
    x1: padL,
    x2: W - padR,
    y1: y(refY),
    y2: y(refY),
    ...
    fill: "#f5c518",
    textAnchor: "end"
  }, "obj ", fmtV(refY))), lineD && /*#__PURE__*/React.createElement("path", {
    d: lineD,
    fill: "none",
    stroke: color,
    strokeWidth: "2.5",
    ...
    return /*#__PURE__*/React.createElement("g", {
      key: i
    }, isLast && /*#__PURE__*/React.createElement("circle", {
      cx: pts[i][0],
      cy: pts[i][1],
      r: "7",
      fill: color,
      ...
      cy: pts[i][1],
      r: isLast ? 4.5 : 3,
      fill: isLast ? color : "#16161b",
      stroke: color,
      strokeWidth: isLast ? 0 : 2
    }), (data.length <= 8 || isLast || isMax) && /*#__PURE__*/React.createElement("text", {
      x: pts[i][0],
      y: pts[i][1] - 9,
      fontSize: isLast ? 10 : 9,
      fontWeight: isLast || isMax ? 800 : 600,
      fill: isLast || isMax ? color : "#8f8f98",
      textAnchor: "middle"
...
const echauffementPour = cible => cible >= 15 ? `~${fmtKg(Math.max(2.5, Math.round(cible * 0.5 / 2.5) * 2.5))} kg × 12-15` : "1 série légère × 15";
...
const buildContext = d => `Historique des séances :\n${histText(d.seances)}\n\n` + `Récup des 7 derniers jours :\n${recupText(d)}\n\n` + `Séries des 7 derniers jours par groupe musculaire : ${musclesText(d)}\n` + `Streak : ${streakSemaines(d)} semaine(s) consécutive(s) avec au moins 2 séances.\n` + (d.prochaine ? `Prochaine séance planifiée : ${d.prochaine.nom} le ${d.prochaine.date}.\n` : "") + poidsText(d) + (mensuText(d) ? `\n${mensuText(d)}` : "") + (objectifsText(d) ? `\n${objectifsText(d)}` : "") + (stagText(d) ? `\n${stagText(d)}` : "") + (ciblesText(d) ? `\n${ciblesText(d)}` : "");
const COACH_BASE = passages => `Tu es un coach de musculation personnel. ` + `Tu tutoies, ton direct, naturel et chaleureux, en français. Réponds UNIQUEMENT en phrases simples : pas de listes, pas de markdown, pas d'émojis. ` + `Règles de progression : ressenti "de la marge" = proposer +2 à 2,5 kg la prochaine fois ; "ça tirait" = garder la même charge. ` + `Tiens compte du sommeil, de l'alimentation et de l'espacement des séances quand ces infos sont fournies : moins de 6 h de sommeil ou une alimentation légère un jour de séance méritent un conseil. ` + `Encourage une douche rapide après la séance si elle n'est pas notée comme faite. ` + `Objectif de poids de corps : ${OBJECTIF_POIDS} kg (prise de masse, entraînement 100 % naturel). Quand un record perso est signalé, félicite sobrement. ` + `Date du jour : ${new Date().toLocaleDateString("fr-FR")}.`;
const getApiKey = () => {
  try {
...
const spGet = k => {
  try {
    return localStorage.getItem("pl:" + k);
  } catch {
    return null;
  }
};
const spSet = (k, v) => {
  try {
    localStorage.setItem("pl:" + k, v);
  } catch {}
};
const spDel = k => {
  try {
    localStorage.removeItem("pl:" + k);
  } catch {}
};
...
const spRand = n => {
  ...
  return Array.from(a).map(x => ("0" + (x & 0xff).toString(16)).slice(-2)).join("").slice(0, n);
};
async function spBeginAuth() {
  ...
  const p = new URLSearchParams({
    ...
    code_challenge: spB64url(digest),
    scope: SP_SCOPES
  });
...
async function spRefresh() {
  ...
  return spTokenReq(new URLSearchParams({
    client_id: SP_CLIENT_ID,
...
async function spApi(path, method = "GET") {
  ...
  if (!tok) throw Object.assign(new Error("noauth"), {
    noauth: true
  });
...
const SpotifyIcon = ({
...
}, disc && /*#__PURE__*/React.createElement("circle", {
  cx: "12",
  cy: "12",
  r: "12",
  fill: "#1DB954"
  ...
  d: "M5.4 9.4 Q12 6.9 18.6 10.6"
}), /*#__PURE__*/React.createElement("path", {
  d: "M6.5 12.6 Q12 10.3 17.6 13.3"
}), /*#__PURE__*/React.createElement("path", {
  d: "M7.5 15.5 Q12 13.6 16.4 15.7"
})));

// Carte « En écoute » : pochette + titre + contrôles (Premium)
function SpNowPlaying({
  now,
  busy,
  onToggle,
  onPrev,
  ...
  const ctl = (glyph, onClick, big) => /*#__PURE__*/React.createElement("button", {
    onClick: onClick,
    disabled: busy,
    ...
    style: {
      ...
      fontSize: big ? 17 : 13,
      lineHeight: 1,
      background: big ? "#fff" : C.card2,
      color: big ? "#0a0a0a" : C.text,
      border: big ? "none" : `1px solid ${C.hair}`,
      opacity: busy ? 0.6 : 1
    }
  }, glyph);
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, (track.artists || []).map(a => a.name).join(", "))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-1.5 shrink-0"
  }, ctl("⏮", onPrev), ctl(playing ? "⏸" : "▶", onToggle, true), ctl("⏭", onNext)));
}
...
function App() {
  ...
  const genererCarte = async s => {
    ...
    exos.forEach(e => {
      ...
      ctx.fillStyle = e.pr ? "#f5c518" : "#8f8f98";
    ...
    if (code) {
      (async () => {
        try {
          ...
          setSpErr("Connexion Spotify échouée — réessaie.");
        } finally {
  ...
  useEffect(() => {
    ...
    const tick = async () => {
      ...
      try {
        ...
        if (e && e.noauth && alive) setSpToken(false);
      }
    };
    tick();
  ...
  const spControl = async action => {
    ...
    try {
      ...
      setTimeout(async () => {
        try {
          const rr = await spApi("me/player");
          if (rr.ok) setSpNow(await rr.json());else if (rr.status === 204) setSpNow(null);
        } catch {}
      }, 400);
    } catch (e) {
      if (e && e.noauth) setSpToken(false);
    } finally {
      setSpBusy(false);
    }
  };
  ...
  const connecterSpotify = () => {
    setSpErr(null);
    spBeginAuth().catch(() => setSpErr("Impossible de lancer la connexion Spotify."));
  };
  const deconnecterSpotify = () => {
    spLogout();
    setSpToken(false);
    setSpNow(null);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      background: "linear-gradient(180deg,#20202a,#191921)",
      border: `1px solid ${C.hair}`,
      color: C.text
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, elapsedTxt, " \xE9coul\xE9es")), showStart && !current && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    size: 18
  })))), data.motDuJour && data.motDuJour.date === todayISO() && /*#__PURE__*/React.createElement(Card, {
    style: {
    ...
    size: 12
  }), " Le mot du coach"), /*#__PURE__*/React.createElement("div", {
    className: "text-sm leading-relaxed"
  }, data.motDuJour.texte)), /*#__PURE__*/React.createElement(Card, null, data.prochaine ? /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3"
  ...
  }, "Pas de notification possible dans l'app \u2014 mets-toi un rappel sur ton iPhone en plus."))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SectionLabel, null, "Musique"), /*#__PURE__*/React.createElement(Card, {
    className: "mt-2"
  }, spToken ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SpNowPlaying, {
    now: spNow,
    busy: spBusy,
    onToggle: spToggle,
    onPrev: () => spControl("previous"),
    onNext: () => spControl("next")
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xs font-semibold flex items-center gap-1.5 min-w-0",
    style: {
      color: "#1DB954"
    }
  }, /*#__PURE__*/React.createElement(SpotifyIcon, {
    ...
    className: "truncate"
  }, "Connect\xE9 \xB7 tu restes connect\xE9")), /*#__PURE__*/React.createElement("button", {
    onClick: deconnecterSpotify,
    className: "pl-tap text-xs font-semibold shrink-0",
    style: {
      color: C.dim
    }
  }, "D\xE9connecter"))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Connecte ton compte pour voir la pochette et piloter la lecture (play / pause / suivant) directement ici, pendant la s\xE9ance."), /*#__PURE__*/React.createElement("button", {
    ...
    size: 16,
    disc: false
  }), " Connecter Spotify")), spErr && /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-2 font-semibold",
    style: {
      color: C.red
    }
  }, spErr))), /*#__PURE__*/React.createElement("div", {
    ...
    value: data.seances.reduce((a, s) => a + s.exos.reduce((x, e) => x + (e.series || 0), 0), 0)
  })), /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-1",
    style: {
      color: C.dim
    ...
    style: {
      ...DISPLAY,
      ...NUMS,
      color: dernierPoids ? C.yellow : C.dim
    }
  }, dernierPoids ? /*#__PURE__*/React.createElement(CountUp, {
    value: dernierPoids.kg,
    decimals: dernierPoids.kg % 1 ? 1 : 0
  }) : "—"), /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-1",
    style: {
      color: C.dim
  ...
  }, "/ ", OBJECTIF_POIDS)))), (!dernierPoids || joursDepuis(dernierPoids.date) >= 7) && /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab("recup"),
    className: "pl-tap w-full text-left text-xs px-1",
    style: {
      color: C.dim
    }
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SectionLabel, null, "Volume 7 jours \xB7 par muscle"), /*#__PURE__*/React.createElement(Card, {
      className: "mt-2",
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, m), /*#__PURE__*/React.createElement(VolBar, {
        pct: pct,
        over: over
      }), /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...NUMS,
          color: over ? C.red : cible ? C.text : C.dim
        }
      }, cible ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("b", {
        style: {
          color: C.text
        }
    ...
    }, "D\xE9tail et cibles dans Progression \u2192")));
  })(), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between mb-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-sm"
  }, "Assiduit\xE9 en salle"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold text-sm"
  }, "Demander \xE0 Claude")), /*#__PURE__*/React.createElement("div", {
    className: "text-xs mb-3 leading-relaxed",
    style: {
      color: C.dim
    }
  }, "Copie ton contexte complet (s\xE9ances, charges, r\xE9cup, poids, volume par muscle) et colle-le dans Claude : il te r\xE9pond avec tout ton historique sous les yeux."), /*#__PURE__*/React.createElement("button", {
    ...
    size: 15
  }), " ", ctxCopie ? "Copié — colle-le dans Claude" : "Copier mon contexte")), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 130,
      borderRadius: "50%",
      background: "radial-gradient(closest-side, rgba(245,197,24,.16), transparent)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex items-center gap-2 text-xs font-extrabold tracking-widest uppercase",
    style: {
      color: C.yellow
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, elapsedTxt, " \xB7 ", seriesJour, " s\xE9rie", seriesJour > 1 ? "s" : "", wakeActive ? " · écran allumé" : "")), /*#__PURE__*/React.createElement("button", {
    onClick: copierEtat,
    ...
    className: "flex items-center gap-2 mt-3 pt-3 relative",
    style: {
      borderTop: `1px solid ${C.hair}`
    }
  ...
  }, "Hydratation"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xl font-bold w-5 text-center",
    style: NUMS
    ...
    size: 14
  }))))), spToken && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(SpNowPlaying, {
    now: spNow,
    busy: spBusy,
    onToggle: spToggle,
    onPrev: () => spControl("previous"),
  ...
  }, "Charges de d\xE9part prudentes \u2014 ajuste au ressenti, c'est fait pour.")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Aucun historique pour ce type de s\xE9ance. Copie ton contexte et demande un plan \xE0 Claude."), /*#__PURE__*/React.createElement("button", {
    onClick: copierContexte,
    ...
    size: 15
  }), " ", ctxCopie ? "Copié — colle-le dans Claude" : "Copier mon contexte"))), planSeance && !ec && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("button", {
  ...
  }))), ec && /*#__PURE__*/React.createElement(Card, {
    style: {
      border: `1px solid ${C.yellow}`
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, ec.sets.length, " s\xE9rie", ec.sets.length > 1 ? "s" : "", " faite", ec.sets.length > 1 ? "s" : "", " \xB7 repos ", fmtRepos(ec.reposSec), ec.parBras ? " · charge par bras" : ""), ec.sets.map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
  ...
  }, "Poids s\xE9rie suivante (kg)"), /*#__PURE__*/React.createElement("input", {
    value: ecPoids,
    ...
    active: fNom === n,
    onClick: () => pickExo(n)
  }, n))), sugg && !isCardio && /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      color: sugg.monte ? C.yellow : C.text
    }
  }, sugg.monte ? `objectif ${fmtKg(sugg.cible)} kg` : `reste à ${fmtKg(sugg.cible)} kg`), sugg.last.pr ? " (record en cours)" : ""), sugg && !isCardio && histoOf(fNom.trim()).length > 1 && /*#__PURE__*/React.createElement("div", {
    className: "text-xs mb-3",
    style: {
      ...NUMS,
      color: C.dim
    ...
    }, rp.machine ? "Indicatif : les charges machine varient beaucoup d'une marque à l'autre." : "Repère standard pour un adulte, charge totale."));
    ...
    size: 11
  }))), rappelPhotoId && /*#__PURE__*/React.createElement("div", {
  ...
  }, "ta machine", /*#__PURE__*/React.createElement("br", null), "(derni\xE8re fois)")))), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 mb-3"
  ...
  }, "/bras")), (!serieMode || editExoId) && /*#__PURE__*/React.createElement(Stepper, {
    label: "S\xE9ries",
    value: fSeries,
    onChange: setFSeries
  }), /*#__PURE__*/React.createElement(Stepper, {
  ...
  }, e.type === "cardio" ? `${e.dureeCardio} min${e.distance ? ` · ${fmtKg(e.distance)} km` : ""}${e.niveau ? ` · niveau ${e.niveau}` : ""}` : `${e.series}×${e.reps} @ ${fmtKg(e.poids)} kg${e.parBras ? "/bras" : ""} · repos ${fmtRepos(e.reposSec)}${e.dureeMin ? ` · ${e.dureeMin} min` : ""}`), e.note && /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-0.5",
    style: {
      ...NUMS,
      color: C.dim
    ...
    onClick: annuler,
    className: "pl-tap px-4 rounded-xl",
    style: {
      background: C.card2,
      color: C.red,
      border: `1px solid ${C.hair}`
    ...
    className: "space-y-3 pl-anim"
  }, /*#__PURE__*/React.createElement(SectionLabel, null, "Check-in du jour"), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    size: 12
  }), " Sommeil de la nuit derni\xE8re"), /*#__PURE__*/React.createElement("div", {
    ...
    size: 12
  }), " Alimentation du jour"), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 mb-2"
  }, [["leger", "Léger"], ["correct", "Correct"], ["solide", "Solide"]].map(([v, l]) => /*#__PURE__*/React.createElement(Chip, {
    key: v,
    active: jourDuJour.alim === v,
    onClick: () => setJour({
      alim: jourDuJour.alim === v ? null : v
    })
  }, l))), /*#__PURE__*/React.createElement("div", {
    className: "mb-4"
  }, /*#__PURE__*/React.createElement(Chip, {
    active: !!jourDuJour.proteines,
    onClick: () => setJour({
      proteines: !jourDuJour.proteines
    })
  }, "Prot\xE9ines OK")), seanceAujourdhui && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "text-xs mb-1 flex items-center gap-1",
    style: {
      color: C.dim
    }
    ...
    size: 12
  }), " Douche direct apr\xE8s la s\xE9ance"), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setJour({
      douche: jourDuJour.douche === true ? null : true
    }),
    className: "flex-1 rounded-xl py-3 font-bold text-sm",
    style: {
  ...
  }, "Faite"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setJour({
      douche: jourDuJour.douche === false ? null : false
    }),
    className: "flex-1 rounded-xl py-3 font-bold text-sm",
    style: {
  ...
  }, "Pas encore")))), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "text-xs mb-2 flex items-center gap-1 font-bold",
    style: {
      color: C.text
    }
  ...
  }, " \xB7 objectif ", OBJECTIF_POIDS, " kg")), dernierPoids && /*#__PURE__*/React.createElement("div", {
    className: "text-sm mb-2",
    style: NUMS
  }, "Dernier : ", /*#__PURE__*/React.createElement("b", null, fmtKg(dernierPoids.kg), " kg"), " ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.dim
    }
  }, "(", joursDepuis(dernierPoids.date) === 0 ? "aujourd'hui" : `il y a ${joursDepuis(dernierPoids.date)} j`, OBJECTIF_POIDS - dernierPoids.kg > 0 ? ` · encore ${fmtKg(OBJECTIF_POIDS - dernierPoids.kg)} kg` : " · objectif atteint !", ")")), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("input", {
    value: pdsInput,
  ...
  }, "Une pes\xE9e par semaine suffit, toujours au m\xEAme moment (le matin \xE0 jeun)."), (data.poids || []).length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "mt-2"
  }, [...(data.poids || [])].reverse().slice(0, 6).map(p => /*#__PURE__*/React.createElement("div", {
    key: p.date,
  ...
  }, fmtShort(p.date)), /*#__PURE__*/React.createElement("div", {
    className: "text-sm flex-1 font-semibold",
    style: NUMS
  }, fmtKg(p.kg), " kg"), /*#__PURE__*/React.createElement("button", {
    onClick: () => supprimerPoids(p.date),
    className: "w-6 h-6 rounded-md flex items-center justify-center shrink-0",
    style: {
      background: C.card2,
      color: C.red
  ...
  }), " Mensurations", /*#__PURE__*/React.createElement("span", {
    className: "font-normal",
    style: {
      color: C.dim
    }
  }, " \xB7 une fois par mois")), /*#__PURE__*/React.createElement("div", {
    ...
    size: 11
  })))))), /*#__PURE__*/React.createElement(SectionLabel, null, "\xC9tat de r\xE9cup"), /*#__PURE__*/React.createElement("div", {
  ...
  }, reposDepuis == null ? "—" : reposDepuis === 0 ? "Auj." : `${reposDepuis} j`), /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-1",
    style: {
      color: C.dim
    }
  }, "depuis la derni\xE8re s\xE9ance")), /*#__PURE__*/React.createElement(Card, {
    className: "text-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-3xl flex items-center justify-center gap-1.5",
    style: {
      ...DISPLAY,
      ...NUMS,
      color: sommeilMoyen != null && sommeilMoyen < 6.5 ? C.red : C.yellow
    }
  }, /*#__PURE__*/React.createElement(Moon, {
    size: 16
  }), sommeilMoyen != null ? `${fmtKg(sommeilMoyen)} h` : "—"), /*#__PURE__*/React.createElement("div", {
    className: "text-xs mt-1",
    style: {
      color: C.dim
    }
  }, "sommeil moyen (7 j)"))), /*#__PURE__*/React.createElement(SectionLabel, null, "7 derniers jours"), /*#__PURE__*/React.createElement(Card, null, [...Array(7)].map((_, i) => {
    const dt = new Date();
    dt.setDate(dt.getDate() - i);
    const iso = isoOf(dt);
    ...
    }, i === 0 ? "Auj." : fmtShort(iso)), /*#__PURE__*/React.createElement(Dumbbell, {
      size: 14,
      className: "shrink-0",
      style: {
        color: seances.length ? C.yellow : C.line
      }
    }), /*#__PURE__*/React.createElement("div", {
      className: "text-xs flex-1 truncate",
      style: {
        color: seances.length ? C.text : C.dim
      }
    }, seances.length ? seances.map(s => s.nom).join(" + ") : "repos"), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-1 text-xs shrink-0",
      style: {
        ...NUMS,
        color: j.sommeil != null ? C.text : C.line
      }
    }, /*#__PURE__*/React.createElement(Moon, {
      size: 12
    }), j.sommeil != null ? fmtKg(j.sommeil) : "—"), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-1 text-xs shrink-0",
      style: {
        color: j.alim ? C.text : C.line
      }
    }, /*#__PURE__*/React.createElement(Utensils, {
      size: 12
    }), j.alim ? ALIM_LABELS[j.alim][0].toUpperCase() : "—"), seances.length > 0 && /*#__PURE__*/React.createElement(ShowerHead, {
      size: 13,
      className: "shrink-0",
      style: {
        color: j.douche === true ? C.green : j.douche === false ? C.red : C.line
      }
    }));
    ...
    size: 14
  }), " ", ctxCopie ? "Copié — colle-le dans Claude" : "Copier ma récup pour Claude"))), tab === "historique" && /*#__PURE__*/React.createElement("div", {
    className: "space-y-3 pl-anim"
    ...
    return /*#__PURE__*/React.createElement(Card, {
      ...
      className: "pl-tap w-full flex items-center gap-3 text-left",
      onClick: () => setExpandedId(open ? null : s.id)
    }, /*#__PURE__*/React.createElement("div", {
      className: "w-11 h-11 rounded-xl flex items-center justify-center shrink-0 text-lg",
      style: {
        background: "radial-gradient(circle at 30% 25%, #2a2a31, #181820)",
        border: `1px solid ${C.hair}`
      }
    ...
    }, s.nom), prCount > 0 && /*#__PURE__*/React.createElement("span", {
      className: "inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-xs font-black shrink-0",
      style: {
        background: C.yellow,
        color: "#111"
      }
      ...
      size: 10
    }), " ", prCount)), /*#__PURE__*/React.createElement("div", {
      className: "text-xs mt-0.5",
      style: {
        ...NUMS,
        color: C.dim
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          background: C.card2,
          color: enEdition ? C.yellow : C.dim
        }
      }, /*#__PURE__*/React.createElement(Pencil, {
        size: 12
      })), /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        color: shareId === s.id ? C.green : C.yellow
      }
  ...
  }, "Records")), progMode === "exo" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "text-xs mb-1",
    style: {
      color: C.dim
    }
  ...
  }, "Tape un groupe pour fixer sa cible de s\xE9ries hebdo. Un groupe \xE0 0 m\xE9rite ta prochaine s\xE9ance."), (() => {
    const dep = new Date();
  ...
  }, "Pas encore de records \u2014 \xE7a vient.") : mursRecords.map((r, idx) => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        background: idx === 0 ? "linear-gradient(90deg, rgba(245,197,24,.08), transparent 70%)" : "none"
      }
    }, /*#__PURE__*/React.createElement("div", {
      className: "w-7 text-center shrink-0"
    }, medal ? /*#__PURE__*/React.createElement("span", {
      className: "text-lg"
    }, medal) : /*#__PURE__*/React.createElement("span", {
      className: "text-xs font-black",
      style: {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        background: `radial-gradient(58% 38% at 50% 40%, ${enRepos ? "rgba(245,197,24,.10)" : "rgba(86,217,138,.10)"}, transparent 72%), #0c0c0e`,
    ...
    }, ec.sets.length, " s\xE9rie", ec.sets.length > 1 ? "s" : "", " faite", ec.sets.length > 1 ? "s" : "", ec.parBras ? " · charge par bras" : "", " \xB7 repos ", fmtRepos(ec.reposSec))), /*#__PURE__*/React.createElement("button", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          background: derniere ? "rgba(245,197,24,.14)" : C.card2,
          border: `1px solid ${derniere ? "rgba(245,197,24,.4)" : C.hair}`,
          color: derniere ? C.yellow : C.dim,
          ...NUMS
        }
      }, i + 1, "\xB7 ", fmtKg(s.poids), "\xD7", s.reps);
    })), /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        lineHeight: 1,
        color: C.green,
        textShadow: "0 0 18px rgba(86,217,138,.5)"
      }
    ...
    }, "s\xE9rie ", ec.sets.length + 1)))), enRepos && /*#__PURE__*/React.createElement("div", {
    ...
    }, "Passer le repos"))), /*#__PURE__*/React.createElement("div", {
      className: "flex gap-3 mb-3"
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex-1"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      size: 22
    }), " S\xE9rie ", ec.sets.length + 1, " faite"), /*#__PURE__*/React.createElement("div", {
      className: "flex gap-2 mt-2"
    }, /*#__PURE__*/React.createElement("button", {
      onClick: finirSerieEtExo,
      className: "flex-1 rounded-xl py-3 font-bold text-sm",
    ...
    }, "Derni\xE8re s\xE9rie \u2192 fin"), /*#__PURE__*/React.createElement("button", {
      onClick: finirExo,
    ...
    }, done ? "C'est reparti" : "Repos"), /*#__PURE__*/React.createElement("div", {
      className: "relative flex items-center justify-center",
      style: {
        width: 260,
        height: 260
    ...
    }, done ? "GO" : `${Math.floor(left / 60)}:${String(left % 60).padStart(2, "0")}`), ec && !done && /*#__PURE__*/React.createElement("div", {
      className: "text-xs mt-2",
      style: {
        color: C.dim
      }
    }, "prochaine : s\xE9rie ", ec.sets.length + 1))), !done && /*#__PURE__*/React.createElement("div", {
