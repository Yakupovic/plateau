...
const MOTS_GENERIQUES = new Set([
  "machine", "guidee", "guide", "assistee", "assiste", "assistance", "poulie", "appareil",
  "sans", "avec", "les", "des", "aux", "pour", "type", "version",
]);
...
const relationExo = (nomA, nomB) => {
  const A = [...new Set(motsCles(nomA))], B = [...new Set(motsCles(nomB))];
...
const RECETTES = [
  // ————— Petits-déjeuners —————
  {
    id: "menemen", nom: "Menemen léger", cat: "petitdej", min: 15, prot: 17, feu: "ok",
    ...
    etapes: [
      "Poivron en dés à la poêle 5 min dans l'huile.",
      "Tomate pelée en morceaux, 5 min à couvert — pas de concentré, trop de potassium et de sel.",
      "Œufs battus versés dessus, brouiller à feu doux jusqu'à cuisson complète (pas de baveux).",
      "Pul biber au moment de servir, à la place du sel.",
    ],
    note: "Tomate fraîche plutôt que concentré : même goût, bien moins de potassium.",
  },
  {
    id: "porridge", nom: "Porridge avoine-pomme", cat: "petitdej", min: 10, prot: 14, feu: "v",
    ...
    etapes: [
      "Flocons + lait, 4 min à feu doux en remuant.",
      "Pomme en dés ajoutée en fin de cuisson.",
      "Cannelle et miel hors du feu.",
    ],
    note: "Compte-le dans ton quota laitage de la journée (phosphore).",
  },
  {
    id: "tartines", nom: "Tartines œuf dur & concombre", cat: "petitdej", min: 12, prot: 18, feu: "ok",
    ...
    etapes: [
      "Œufs 9 min à l'eau bouillante — jaune bien pris.",
      "Pain grillé, concombre en rondelles dessus.",
      "Œufs écrasés à la fourchette, sumac et filet d'huile.",
    ],
    note: "Le sumac remplace le sel et donne l'acidité.",
  },
  {
    id: "skyr", nom: "Bol skyr, flocons & myrtilles", cat: "petitdej", min: 5, prot: 22, feu: "v",
  ...
  {
    id: "omelette-epinards", nom: "Omelette épinards", cat: "petitdej", min: 12, prot: 20, feu: "ok",
    ...
    etapes: [
      "Épinards bien égouttés, réchauffés à la poêle.",
      "Œufs battus versés dessus, cuisson complète à feu moyen.",
      "Poivre et cumin, pas de sel ajouté.",
    ],
  ...
  // ————— Post-séance —————
  {
    id: "poulet-riz", nom: "Poulet citron-cumin & riz", cat: "post", min: 25, prot: 40, feu: "ok",
    ...
    etapes: [
      "Poulet en lanières mariné 10 min dans citron, cumin, paprika, huile.",
      "Riz à l'eau non salée, 11 min.",
      "Poulet à la poêle bien chaude 8-10 min, cœur blanc à la coupe.",
      "Courgette en rondelles ajoutée les 5 dernières minutes.",
    ],
    note: "À manger dans les 2 h après la séance, avec le riz : glucides + protéines ensemble.",
  },
  {
    id: "durum", nom: "Dürüm poulet, sauce yaourt-menthe", cat: "post", min: 20, prot: 34, feu: "v",
    ...
    etapes: [
      "Poulet en lanières, poêle bien chaude, cuisson à cœur.",
      "Yaourt + menthe + ail écrasé = la sauce, aucun sel.",
      "Garnir la galette, rouler serré.",
    ],
    note: "Salade lavée soigneusement à l'eau vinaigrée — immunosuppresseurs obligent.",
  },
  {
    id: "kofte-boulgour", nom: "Köfte au four & boulgour", cat: "post", min: 35, prot: 33, feu: "ok",
    ...
    etapes: [
      "Mélanger viande, oignon râpé, persil, épices, chapelure.",
      "Former 5-6 boulettes, four 200 °C, 18 min, bien cuites à cœur.",
      "Boulgour gonflé 15 min dans l'eau chaude non salée.",
    ],
    note: "Haché toujours à cuisson complète, jamais rosé.",
  },
  {
    id: "thon-pain", nom: "Sandwich thon-concombre", cat: "post", min: 8, prot: 29, feu: "v",
    ...
    etapes: [
      "Thon rincé et bien égoutté — ça enlève une bonne part du sel.",
      "Écrasé avec le yaourt, citron, poivre.",
      "Concombre en rondelles, montage direct.",
    ],
    note: "Une boîte, pas deux : le thon en conserve reste salé.",
  },
  {
    id: "smoothie", nom: "Smoothie avoine-pomme", cat: "post", min: 5, prot: 15, feu: "v",
  ...
  // ————— Déjeuners —————
  {
    id: "poulet-four", nom: "Poulet rôti & légumes du four", cat: "dej", min: 45, prot: 38, feu: "ok",
    ...
    etapes: [
      "Légumes en gros morceaux sur la plaque, huile et épices.",
      "Poulet posé dessus, four 200 °C, 35-40 min.",
      "Vérifier que le jus qui sort est clair avant de servir.",
    ],
    note: "Doubler les quantités : ça fait le repas du lendemain.",
  },
  {
    id: "pates-dinde", nom: "Pâtes complètes à la dinde", cat: "dej", min: 25, prot: 36, feu: "ok",
    ...
    etapes: [
      "Oignon et ail revenus, dinde émiettée jusqu'à cuisson complète.",
      "Tomates pelées en dés, 15 min à découvert pour réduire.",
      "Pâtes cuites à l'eau non salée, mélangées à la sauce.",
    ],
    note: "Réduire les tomates fraîches donne le goût du concentré sans son potassium.",
  },
  {
    id: "pilav-dinde", nom: "Pilav & escalope de dinde", cat: "dej", min: 25, prot: 37, feu: "ok",
    ...
    etapes: [
      "Vermicelles dorés au beurre, riz ajouté, eau à hauteur, 12 min à couvert.",
      "Escalope à la poêle 4 min par face, citron en fin.",
      "Salade lavée à part, vinaigrette citron-huile d'olive.",
    ],
    note: "Riz rincé avant cuisson : moins d'amidon, meilleure texture.",
  },
  {
    id: "karniyarik", nom: "Karnıyarık allégé", cat: "dej", min: 50, prot: 30, feu: "ok",
    ...
    etapes: [
      "Aubergines coupées en deux, badigeonnées d'huile, four 200 °C 20 min.",
      "Viande revenue avec oignon et persil, cuisson complète.",
      "Creuser, farcir, tomate en rondelles dessus, 20 min de plus au four.",
    ],
    note: "Au four, l'aubergine boit trois fois moins d'huile qu'à la poêle.",
  },
  {
    id: "cabillaud", nom: "Cabillaud citron-persil & riz", cat: "dej", min: 25, prot: 34, feu: "ok",
    ...
    etapes: [
      "Poisson en papillote avec citron, persil, huile.",
      "Four 190 °C, 18 min — chair opaque qui se détache.",
      "Riz et haricots verts à l'eau non salée.",
    ],
    note: "Poisson toujours bien cuit, jamais mi-cuit ni fumé à froid.",
  },
  {
    id: "mercimek", nom: "Soupe mercimek (portion mesurée)", cat: "dej", min: 30, prot: 18, feu: "v",
    ...
    etapes: [
      "Lentilles rincées et trempées 30 min, eau jetée — ça retire du potassium.",
      "Oignon et carotte revenus, lentilles ajoutées, eau, 20 min.",
      "Mixer, cumin et menthe, citron au moment de servir.",
    ],
    note: "60 g de lentilles sèches, pas plus, et jamais deux jours de suite.",
  },
  {
    id: "taboule", nom: "Taboulé boulgour & poulet grillé", cat: "dej", min: 20, prot: 32, feu: "ok",
    ...
    etapes: [
      "Boulgour gonflé 20 min dans l'eau chaude, égoutté.",
      "Poulet grillé, refroidi, coupé en dés.",
      "Herbes hachées, concombre, citron, huile — tout mélanger.",
    ],
  ...
  // ————— Dîners —————
  {
    id: "oeufs-cocotte", nom: "Œufs cocotte aux épinards", cat: "diner", min: 20, prot: 21, feu: "ok",
    ...
    etapes: [
      "Épinards fondus à la poêle, égouttés.",
      "Répartis dans un ramequin, œufs cassés dessus, crème.",
      "Four 180 °C 14 min : blanc pris, jaune ferme.",
    ],
    note: "Blanc ET jaune bien pris — pas d'œuf coulant.",
  },
  {
    id: "poulet-poivrons", nom: "Sauté poulet-poivrons & boulgour", cat: "diner", min: 25, prot: 35, feu: "ok",
    ...
    etapes: [
      "Poulet saisi à feu vif, réservé.",
      "Poivrons et oignon 8 min, poulet remis, épices.",
      "Boulgour gonflé à part, servi dessous.",
    ],
    note: "Sumac + pul biber : le duo qui te fait oublier la salière.",
  },
  {
    id: "omelette-salade", nom: "Omelette turque & salade", cat: "diner", min: 15, prot: 19, feu: "ok",
    ...
    etapes: [
      "Œufs battus avec persil et oignon haché.",
      "Poêle huilée, feu moyen, 4 min par face.",
      "Salade lavée soigneusement, assaisonnée au citron.",
    ],
    note: "Assaisonner au citron plutôt qu'au vinaigre balsamique (souvent salé/sucré).",
  },
  {
    id: "pide", nom: "Pide maison viande hachée", cat: "diner", min: 35, prot: 31, feu: "ok",
    ...
    etapes: [
      "Viande revenue avec oignon, poivron, tomate — cuisson complète.",
      "Pâte étalée en barque, garniture au centre, bords repliés.",
      "Four 220 °C, 15 min.",
    ],
    note: "Sans fromage ajouté : la garniture suffit et le phosphore reste bas.",
  },
  {
    id: "dinde-haricots", nom: "Dinde aux haricots verts", cat: "diner", min: 25, prot: 36, feu: "ok",
    ...
    etapes: [
      "Haricots cuits 12 min à l'eau non salée.",
      "Dinde en lanières saisie avec l'ail.",
      "Haricots ajoutés 3 min, citron au moment de servir.",
    ],
    note: "Haricots verts : un des légumes les plus doux en potassium.",
  },
  {
    id: "yogurtlu", nom: "Bol de riz yoğurtlu au poulet", cat: "diner", min: 20, prot: 33, feu: "v",
    ...
    etapes: [
      "Riz cuit à l'eau non salée.",
      "Poulet en dés saisi à la poêle.",
      "Yaourt battu avec ail et menthe, nappé sur le bol.",
    ],
  ...
  // ————— Collations —————
  {
    id: "yaourt-miel", nom: "Yaourt, miel & flocons", cat: "collation", min: 3, prot: 10, feu: "v",
  ...
  {
    id: "pomme-amandes", nom: "Pomme & poignée d'amandes", cat: "collation", min: 1, prot: 6, feu: "v",
  ...
  {
    id: "oeuf-pain", nom: "Œuf dur & pain complet", cat: "collation", min: 10, prot: 12, feu: "ok",
  ...
  {
    id: "sutlac", nom: "Sütlaç maison", cat: "collation", min: 30, prot: 9, feu: "v",
    resume: "Le riz au lait turc, sucré raisonnablement.",
    ing: [["Riz rond", "40 g"], ["Lait", "300 ml"], ["Sucre", "1 c. à s."], ["Cannelle", "au goût"]],
    etapes: [
      "Riz précuit 10 min à l'eau.",
      "Lait ajouté, feu doux 20 min en remuant.",
      "Sucre en fin de cuisson, cannelle au service.",
    ],
    note: "Une portion, et c'est ton laitage du jour.",
  },
  {
    id: "toast-cacahuete", nom: "Toast beurre de cacahuète", cat: "collation", min: 3, prot: 9, feu: "v",
...
const SOFRA_CATS = [
  ...
  { id: "post", label: "Post-séance" },
  { id: "collation", label: "Collation" },
];
const SOFRA_CAT_LABEL = { petitdej: "Petit-déj", dej: "Déjeuner", diner: "Dîner", post: "Post-séance", collation: "Collation" };
...
const planDuJour = (conseil, faitAujourdhui) => {
  if (faitAujourdhui) {
    return {
      ...
      slots: [{ cat: "post", label: "Après la séance" }, { cat: "diner", label: "Le soir" }, { cat: "collation", label: "Si petite faim" }],
    };
  }
  if (conseil && conseil.type === "repos") {
    return {
      ...
      slots: [{ cat: "petitdej", label: "Ce matin" }, { cat: "dej", label: "Ce midi" }, { cat: "diner", label: "Ce soir" }],
    };
  }
  ...
  return {
    titre: `Jour ${t}`,
    sous: gros
      ? "Grosse séance : charge en glucides au repas d'avant, tu vas en avoir besoin."
      : "Repas d'avant digeste, le gros des glucides après la séance.",
    slots: [{ cat: "petitdej", label: "Ce matin" }, { cat: "collation", label: "1 h 30 avant la salle" }, { cat: "post", label: "Après la séance" }],
  };
};

const SOFRA_REPERES = [
  {
    t: "Les règles d'or", ic: "⭐",
    l: [
      "Pas de pamplemousse ni de carambole, sous aucune forme (jus compris).",
      "Rien de cru côté viande, œuf, poisson : tout à cuisson complète.",
      "Fromages au lait pasteurisé uniquement.",
      "Salade et fruits lavés soigneusement avant de les manger.",
    ],
  },
  {
    t: "Le sel", ic: "🧂",
    l: [
      "Le sel caché est ailleurs : conserves, plats préparés, charcuterie, pain industriel, bouillon cube.",
      "Sumac, pul biber, cumin, menthe séchée, citron : c'est ce qui remplace la salière sans frustration.",
      "Rincer le thon ou les légumes en conserve enlève une bonne part du sodium.",
      "L'ayran est très salé — plaisir occasionnel, pas boisson quotidienne.",
    ],
  },
  {
    t: "Le potassium", ic: "🍌",
    l: [
      "À surveiller : banane, concentré de tomate, fruits secs, avocat, légumineuses en grande quantité.",
      "Pommes de terre : couper en morceaux, tremper 2 h, puis cuire dans une eau qu'on jette.",
      "Les légumineuses se trempent et l'eau de trempage se jette.",
      "Pomme, poire, myrtilles, haricots verts, courgette : les alternatives douces.",
    ],
  },
  {
    t: "Le phosphore", ic: "🥛",
    l: [
      "Un gros laitage par jour suffit — pas skyr le matin ET yaourt le soir.",
      "Les additifs à éviter : E338 à E343, E450 à E452 (sodas, fromages fondus, viandes industrielles).",
      "Le phosphore des additifs s'absorbe presque entièrement, celui des aliments beaucoup moins.",
      "Oléagineux : une petite poignée, pas le paquet.",
    ],
  },
  {
    t: "Muscu & protéines", ic: "💪",
    l: [
      "Ton repère est 1,2 g par kilo et par jour, réparti sur les repas — pas empilé au dîner.",
      "Pas de whey ni de protéine en poudre sans feu vert de ton néphrologue.",
      "Les glucides autour de la séance font autant pour la prise de masse que les protéines.",
      "Prendre du poids se joue sur les calories totales : c'est souvent le petit-déj et la collation qui manquent.",
    ],
  },
  {
    t: "Ce que ça ne remplace pas", ic: "🩺",
    l: [
      "Ces repères sont indicatifs et volontairement prudents.",
      "Tes bilans sanguins et l'avis de ton néphrologue passent avant tout ce qui est écrit ici.",
      "Un changement d'alimentation qui vise la prise de masse se signale en consultation.",
    ],
  },
];
...
const SofraTab = ({ data, saveData, poidsCorps, conseil, faitAujourdhui }) => {
  ...
  const ajouterCourses = (r) => {
    ...
    majSofra({ courses: [...sofra.courses, ...nouv] });
  };
  ...
  const CarteRecette = ({ r, label }) => (
    <Card onClick={() => setOuverte(r.id)} style={{ cursor: "pointer" }}>
      {label && <div className="text-xs font-bold mb-1" style={{ color: C.yellowDim }}>{label}</div>}
      <div className="flex items-start justify-between gap-2">
        <div className="flex-1">
          <div className="font-bold" style={{ fontSize: 17 }}>{r.nom}</div>
          <div className="text-sm mt-0.5" style={{ color: C.dim }}>{r.resume}</div>
        </div>
        <div className="text-right shrink-0">
          <div className="font-black" style={{ ...DISPLAY, ...NUMS, fontSize: 20, color: C.yellowDim }}>{r.prot}<span style={{ fontSize: 12 }}> g</span></div>
    ...
    <div className="space-y-3 pl-anim">
      ...
      {vue === "jour" && (
        <div className="space-y-3">
          <Card style={{ background: C.cardGrad }}>
            ...
            <div className="text-sm mt-1" style={{ color: C.dim }}>{plan.sous}</div>
          ...
          {plan.slots.map((s, i) => {
            ...
            return (
              <div key={s.cat + i}>
                ...
                <button
                  onClick={() => setDecal({ ...decal, [s.cat + i]: (decal[s.cat + i] || 0) + 1 })}
      ...
      {vue === "recettes" && (
        <div className="space-y-3">
          ...
          <div className="text-xs" style={{ color: C.dim }}>{liste.length} recette{liste.length > 1 ? "s" : ""}</div>
          <div className="space-y-2">
            {liste.map((r) => <CarteRecette key={r.id} r={r} />)}
      ...
      {vue === "courses" && (
        <div className="space-y-3">
          {!sofra.courses.length && (
            <Card>
              <div className="font-bold mb-1">Liste vide</div>
              <div className="text-sm" style={{ color: C.dim }}>
                Ouvre une recette et touche « Ajouter aux courses » : les ingrédients arrivent ici.
              </div>
            </Card>
          )}
          {sofra.courses.map((item) => {
            const fait = (sofra.faits || []).indexOf(item) !== -1;
            return (
              <div key={item} className="flex items-center gap-3 rounded-xl px-3 py-3" style={{ background: C.card, border: `1px solid ${C.line}` }}>
                <button onClick={() => basculerFait(item)} className="pl-tap shrink-0 rounded-lg" style={{ width: 26, height: 26, border: `2px solid ${fait ? C.green : C.line}`, background: fait ? C.green : "transparent", color: C.onGreen, fontWeight: 900 }}>
                  {fait ? "✓" : ""}
                </button>
                <div className="flex-1 text-sm" style={{ textDecoration: fait ? "line-through" : "none", color: fait ? C.dim : C.text }}>{item}</div>
                <button onClick={() => majSofra({ courses: sofra.courses.filter((x) => x !== item), faits: (sofra.faits || []).filter((x) => x !== item) })} className="pl-tap px-2" style={{ color: C.dim }}>✕</button>
              </div>
            );
          })}
          {sofra.courses.length > 0 && (
            <button onClick={() => majSofra({ courses: [], faits: [] })} className="pl-tap w-full rounded-xl py-3 font-semibold" style={{ background: C.card2, color: C.red, border: `1px solid ${C.hair}` }}>
              Vider la liste
            </button>
          )}
        </div>
              ...
              <ul className="space-y-1.5">
                {b.l.map((x, i) => (
                  <li key={i} className="text-sm flex gap-2" style={{ color: C.dim }}>
                    <span style={{ color: C.yellowDim }}>—</span><span>{x}</span>
                  </li>
                ))}
              </ul>
            </Card>
      ...
      {rec && (
        <div className="fixed inset-0 z-50 overflow-y-auto" style={{ background: C.bgAlt }}>
          <div className="mx-auto p-4 pb-24" style={{ maxWidth: "28rem" }}>
            <button onClick={() => setOuverte(null)} className="pl-tap mb-3 rounded-xl px-3 py-2 font-semibold" style={{ background: C.card2, color: C.text, border: `1px solid ${C.hair}` }}>
              ← Retour
            </button>
            <div className="font-black" style={{ ...DISPLAY, fontSize: 27, lineHeight: 1.1 }}>{rec.nom}</div>
            <div className="text-sm mt-1" style={{ color: C.dim }}>{rec.resume}</div>

            <div className="flex gap-2 mt-3">
              {[[rec.prot + " g", "protéines"], [rec.min + " min", "préparation"], [SOFRA_CAT_LABEL[rec.cat], "moment"]].map(([v, l]) => (
                <div key={l} className="flex-1 rounded-xl px-2 py-2 text-center" style={{ background: C.card, border: `1px solid ${C.line}` }}>
                  <div className="font-black" style={{ ...NUMS, fontSize: 15 }}>{v}</div>
            ...
            <Card className="mt-3">
              ...
              {rec.ing.map((i) => (
                <div key={i[0]} className="flex justify-between text-sm py-1" style={{ borderBottom: `1px solid ${C.hair}` }}>
            ...
            <Card className="mt-3">
              <div className="font-bold mb-2">Préparation</div>
              <ol className="space-y-2">
                {rec.etapes.map((e, i) => (
                  <li key={i} className="text-sm flex gap-2.5">
                    <span className="shrink-0 rounded-lg text-center font-black" style={{ width: 22, height: 22, lineHeight: "22px", background: C.card2, color: C.yellowDim, fontSize: 12 }}>{i + 1}</span>
                    <span>{e}</span>
                  </li>
                ))}
              </ol>
            ...
            {rec.note && (
              <Card className="mt-3" style={{ background: C.warnBg, border: `1px solid ${C.line}` }}>
                <div className="text-sm"><b>À savoir — </b>{rec.note}</div>
              </Card>
            )}
          </div>
        </div>
...
function App() {
  ...
  const validerExo = async () => {
    ...
    if (isCardio && !editExoId) {
      ...
      const exo = {
        id: uid(), nom: nomCanonique(fNom.trim(), allExos), type: "cardio",
        dureeCardio: fDuree,
    ...
    if (editExoId) {
      if (isCardio) {
        const cur0 = {
          ...
          exos: current.exos.map((e) =>
            e.id === editExoId
              ? {
                  ...e, nom: nomCanonique(fNom.trim(), allExos), type: "cardio", dureeCardio: fDuree,
                  distance: String(fDistance).trim() ? parseFloat(String(fDistance).replace(",", ".")) : null,
      ...
      const cur = {
        ...
        exos: current.exos.map((e) =>
          e.id === editExoId
            ? { ...e, nom: nomCanonique(fNom.trim(), allExos), poids, parBras: fParBras, series: fSeries, reps: fReps, reposSec: fRepos, ressenti: fRessenti, coach: null, sets: null, note: e.sets ? null : e.note }
            : e
        ),
      };
      await saveCurrent(cur);
    ...
    if (serieMode) {
      const exoEnCours = {
        id: uid(), nom: nomCanonique(fNom.trim(), allExos), parBras: fParBras, reposSec: fRepos,
    ...
    const prevAt = current.exos.length ? current.exos[current.exos.length - 1].at || current.startedAt : current.startedAt;
    const exo = {
      id: uid(), nom: nomCanonique(fNom.trim(), allExos), poids, parBras: fParBras,
  ...
  const stagnationPoids = useMemo(() => {
    ...
    const debut = fenetre[0], fin = fenetre[fenetre.length - 1];
    ...
    return { delta, actuel: fin.kg, jours: joursDepuis(debut.date), prise: vise > 0 };
  }, [data.poids]);
          ...
          <div className="pl-anim" style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            {stagnationPoids && (
              <div
                ...
                style={{ background: C.warnBg, border: `1px solid ${C.yellow}`, color: C.yellowDim }}
              >
                ⚖️ {stagnationPoids.actuel} kg — {stagnationPoids.delta === 0 ? "stable" : `${stagnationPoids.delta > 0 ? "+" : ""}${stagnationPoids.delta} kg`} en {stagnationPoids.jours} jours,
                {" "}alors que tes charges montent. En {stagnationPoids.prise ? "prise de masse" : "sèche"}, c'est l'assiette qui bloque, pas l'entraînement.
              </div>
            )}
                  ...
                  return (
                    <div key={id} className="flex items-center gap-2 py-1.5" style={{ borderTop: `1px solid ${C.line}` }}>
                      <button
                        ...
                        className="rounded-md flex items-center justify-center shrink-0 text-xs"
                        style={{ width: 22, height: 22, background: visible ? C.green : C.card2, border: `1px solid ${visible ? C.green : C.line}`, color: C.onGreen }}
                      >
                        {visible ? "✓" : ""}
                      </button>
              ...
              <>
                ...
                {!ec && (
                  <Card style={editExoId ? { border: `1px solid ${C.yellow}` } : undefined}>
                    ...
                    {variantesConnues.length > 0 && !doublonProbable && (
                      <div className="rounded-xl px-3 py-2 mb-3 text-xs leading-relaxed" style={{ background: C.card2, border: `1px solid ${C.hair}` }}>
                        <div style={{ color: C.dim }}>Nouveau réglage — voilà tes repères sur le même mouvement :</div>
                        {variantesConnues.map((v) => {
                          const h = histoOf(v);
                          const d = h.length ? h[h.length - 1] : null;
                          return (
                            <button key={v} onClick={() => pickExo(v)} className="w-full text-left mt-1" style={{ ...NUMS }}>
                              <b>{v}</b>
                              {d ? <span style={{ color: C.dim }}> — {fmtKg(d.poids)} kg le {fmtShort(d.date)}</span> : null}
                            </button>
                          );
                        })}
                        <div className="mt-1" style={{ color: C.dim }}>Tape un nom pour reprendre cette variante, sinon continue.</div>
                      </div>
                    )}
                    ...
                    {!isCardio && !editExoId && (
                      <div className="text-xs mb-1.5" style={{ color: fParBras ? C.yellowDim : C.dim }}>
                        {fParBras
                          ? `Charge par bras : ${String(fPoids).trim() ? fmtKg((parseFloat(String(fPoids).replace(",", ".")) || 0) * 2) + " kg" : "le double"} compté au total.`
                          : "Le poids affiché sur la machine. Coche /bras seulement si chaque bras porte cette charge (haltères, machine à charges séparées)."}
                      </div>
                    )}
                    <div className="mb-3">
                ...
                {ec ? (() => {
                  ...
                  return (
                    <>
                      ...
                      {d && (
                        <div className="inline-block rounded-xl px-3 py-1.5 mt-2 text-base font-bold"
                          style={{ ...NUMS, background: C.okBg, border: `1px solid ${C.green}`, color: C.green }}>
                          ✓ {fmtKg(d.poids)} kg × {d.reps}{ec.parBras ? " /bras" : ""}
                        </div>
                      )}
                    </>
                  );
                  ...
                  return (
                    <>
                      <div className="text-base mt-0.5 font-semibold">{d.nom}</div>
                      <div className="inline-block rounded-xl px-3 py-1.5 mt-2 text-base font-bold"
                        style={{ ...NUMS, background: C.okBg, border: `1px solid ${C.green}`, color: C.green }}>
                        {d.type === "cardio"
                          ? `✓ ${d.dureeCardio} min`
                          : `✓ ${d.series} × ${d.reps} @ ${fmtKg(d.poids)} kg${d.parBras ? " /bras" : ""}`}
                      </div>
                      <div className="mt-2">
                        <button
                          onClick={() => { fermer(); editerExo(d); }}
      ...
      {bilanSeance && (() => {
        ...
        return (
          ...
          >
            ...
            <div className="mt-4 w-full rounded-2xl p-3.5" style={{ maxWidth: 340, background: C.card, border: `1px solid ${ressentiDuJour.fatigue && ressentiDuJour.motivation ? C.green : C.yellow}` }}>
              <div className="text-xs font-black tracking-widest uppercase mb-2.5" style={{ color: ressentiDuJour.fatigue && ressentiDuJour.motivation ? C.green : C.yellowDim }}>
                {ressentiDuJour.fatigue && ressentiDuJour.motivation ? "Ressenti noté ✓" : "Comment tu te sens ?"}
              </div>
              {[["fatigue", "Fatigue", ["😴", "😐", "💪"]], ["motivation", "Motivation", ["👎", "😐", "🔥"]]].map(([cle, titre, emojis]) => (
                    ...
                    {emojis.map((e, i) => {
                      ...
                      return (
                        <button
                          ...
                          style={{ width: 48, height: 44, fontSize: 22, background: actif ? C.yellow : C.card2, border: `1px solid ${actif ? C.yellow : C.line}` }}
                        >
                          {e}
                        </button>
                      );
              ...
              {douleurZone && (
                <>
                  ...
                  <button
                    ...
                    style={{ background: douleurOk ? C.green : C.yellow, color: douleurOk ? C.onGreen : C.onYellow }}
                  >
            ...
            <button
              ...
              className="pl-tap mt-3 w-full rounded-2xl py-4 font-black"
              style={{ maxWidth: 340, background: C.yellow, color: C.onYellow }}
            >
              {ressentiDuJour.fatigue && ressentiDuJour.motivation ? "Terminé" : "Terminer sans noter le ressenti"}
            </button>
      ...
      <div className="pl-tabbar">
        <div className="pl-tabbar-in">
          {[
            ...
            { id: "sofra", label: "Sofra", Icon: Utensils },
